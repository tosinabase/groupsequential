...
if (sys.nframe() == 0){
  ...
  plan = calculate_plan(M, l0, l1, th0, th1, gam, thgam, costs, precision=precision, print_output=TRUE)
  # print(plan)

  oc_th0 = operating_characteristic(plan, th0)
  oc_th1 = operating_characteristic(plan, th1)
  alpha = 1 - oc_th0
  beta = oc_th1


  paste("l0", l0, "l1", l1)
  paste("th0", th0, "th1", th1)
  print("M")
  print(M)
  ...
  asn_0 = average_sampling_cost(plan, th0)
  asn_1 = average_sampling_cost(plan, th1)
  print("asn with theta 0")
  print(asn_0)

  print("asn with theta 1")
  print(asn_1)



  print(step_quantile(plan, thgam, 0.99))
  print(sample_number_quantile(plan, thgam, 0.99))
